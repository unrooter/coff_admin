    ...
    <div id="content">
       ...
       <div class="main-content-inner">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form style="margin: 2% 0 0 10%;" id="form1" class="form-horizontal" name="form1" method="post" action="<?php echo U('Picture/runedit');?>" enctype="multipart/form-data">
                          <div class="form-group">
                              <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
                                 轮播图名称：<input type="text" class="form-control" id="luname" name="luname" value="<?php echo ($data["luname"]); ?>"/>
                              </div>
                              <div class="form-group">
                                 轮播图链接：<input type="text" class="form-control" style="margin:3% 0 0 0;" id="img_link" name="img_link" value="<?php echo ($data["img_link"]); ?>"/>
                              </div>
                              <div class="form-group" style="padding:3% 0;">
                                <label  for="exampleInputFile">上传图片：
                                <input type="file" name ="picture" id="exampleInputFile"  value="<?php echo ($data["img_url"]); ?>"></label>
                              </div>
                            <label>预览:<img style="width:335px;height:117px;boreder:1px solid #333;margin:0 0 2% 5%;" src="/coffee/Public<?php echo ($data["img_url"]); ?>" alt="轮播图" class="img-thumbnail"></label>
            ...
            <script src="/coffee/Public/js/jquery.js"></script>
