...
<html lang="en">
	...
	<body>
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="submenu active open">
					...
					<ul>
						<li class="active"><a href="common.html">Common elements</a></li>
		...
		<div id="content">
            ...
            <script src="/coffee/Public/js/bootstrap-colorpicker.js"></script>
            <script src="/coffee/Public/js/bootstrap-datepicker.js"></script>
            <script src="/coffee/Public/js/jquery.uniform.js"></script>
            <script src="/coffee/Public/js/select2.min.js"></script>
            <script src="/coffee/Public/js/unicorn.js"></script>
            <script src="/coffee/Public/js/unicorn.form_common.js"></script>
	</body>
</html>