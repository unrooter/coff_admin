    ...
    <div id="content">
        <div id="content-header">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form style="margin: 2% 0 0 10%;" id="form1" class="form-horizontal" name="form1" method="post" action="<?php echo U('Content/runedit');?>" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($list["id"]); ?>">
                            <div class="form-group dropdown">
                                主板块名：<select name="pid">
                                <option class="selected"   value="0">不选择默认为添加主板块</option>
                                <option  value="<?php echo ($list[0]["id"]); ?>"> <?php echo ($list["ban_name"]); ?></option>
                            </select>
                            </div>
                            <div class="form-group" style="margin:2% 0 0 0;" >
                                添加板块：<input type="text" name="ban_name" id="ban_name" value="<?php echo ($list["ban_name"]); ?>"/>
                            </div>

                            <div class="form-group" style="margin:2% 0 0 0;" >
                                板块介绍：<textarea name="ban_info" id="ban_info"><?php echo ($list["ban_info"]); ?></textarea>
                            </div>
                            ...
                            <div class="form-group" style="margin:2% 0 2% 0;">
                                板块状态：
                                <?php if($list[status] == 1): ?><button class="btn btn-miniter btn-success">显示</button>
                                <?php else: ?>
                                    <button class="btn brn-miniter btn-danger">不显</button><?php endif; ?>（列表页修改）
                            </div>
